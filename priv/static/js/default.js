...
function inWords(num) {
  if (num === 0) {
    ...
    return inWords(Math.floor(num / 1000000000)) + ' billion ' + inWords(num % 1000000000);
  } else if (num >= 1000000) {
    return inWords(Math.floor(num / 1000000)) + ' million ' + inWords(num % 1000000);
  } else if (num >= 1000) {
    return inWords(Math.floor(num / 1000)) + ' thousand ' + inWords(num % 1000);
  } else if (num >= 100) {
    return inWords(Math.floor(num / 100)) + ' hundred ' + inWords(num % 100);
  } else if (num >= 20) {
