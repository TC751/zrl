defmodule ZrlWeb.ConsignmentView do
  use ZrlWeb, :view
  alias Zrl.Accounts.RailwayAdministrator, as: Operator
  ...
  defp rate_cols(tarrif_id, operators) do
    rates = Zrl.Order.tarrif_rates(tarrif_id)
  ...
  defp locomotives_list(entry) do
    case entry.loco_no do
      ...
      _ ->
        ...
        |> Zrl.Locomotives.locomotives_lookup()
        |> Enum.join(", ")
    end
  end
end
