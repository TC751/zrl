defmodule ZrlWeb.InterchangeView do
  use ZrlWeb, :view

  alias Elixlsx.{Workbook, Sheet}
  alias Zrl.SystemUtilities.{Wagon, Station}
  ...
  def loco_row(entry) do
    [
      [
        ...
        [
          ZrlWeb.MovementView.locomotives_list(entry)
        ],
        [
          entry.train_no || ""
        ],
  ...
  def rate_row(entry) do
    Zrl.SystemUtilities.interchange_defect_spare_lookup(entry.id, entry.adminstrator_id)
