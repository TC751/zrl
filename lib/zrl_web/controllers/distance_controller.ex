defmodule ZrlWeb.DistanceController do
  ...
  plug ZrlWeb.Plugs.Authenticate,
       [module_callback: &ZrlWeb.DistanceController.authorize/1]
  ...
  def distnace_km_lookup(conn, %{"destin" => destin, "station_orig" => station_orig}) do
    distance = Zrl.SystemUtilities.distance_lookup(destin, station_orig)
