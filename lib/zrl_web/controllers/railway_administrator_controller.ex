defmodule ZrlWeb.RailwayAdministratorController do
  use ZrlWeb, :controller

  alias Zrl.Accounts.RailwayAdministrator
  ...
  plug ZrlWeb.Plugs.Authenticate,
       [module_callback: &ZrlWeb.RailwayAdministratorController.authorize/1]
       when action not in [:unknown]
