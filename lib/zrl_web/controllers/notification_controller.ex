defmodule ZrlWeb.NotificationController do
  use ZrlWeb, :controller

  alias Zrl.Notifications
  alias Zrl.Notifications.Email
  ...
  plug ZrlWeb.Plugs.Authenticate,
       [module_callback: &ZrlWeb.NotificationController.authorize/1]
       when action not in [:unknown]
