defmodule Zrl.Order.Batch do
  ...
  schema "tbl_batch" do
    ...
    belongs_to :last_user, Zrl.Accounts.User, foreign_key: :last_user_id, type: :id
    belongs_to :current_user, Zrl.Accounts.User, foreign_key: :current_user_id, type: :id
