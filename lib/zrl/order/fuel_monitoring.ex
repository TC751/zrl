defmodule Zrl.Order.FuelMonitoring do
  use Ecto.Schema
  ...
  schema "tbl_fuel_monitoring" do
    ...
    belongs_to :depo_refueled, Zrl.SystemUtilities.Rates,
      foreign_key: :depo_refueled_id,
      type: :id

    belongs_to :depo_station, Zrl.SystemUtilities.Station, foreign_key: :depo_stn, type: :id

    belongs_to :train_destination, Zrl.SystemUtilities.Station,
      foreign_key: :train_destination_id,
      type: :id

    belongs_to :train_origin, Zrl.SystemUtilities.Station,
      foreign_key: :train_origin_id,
      type: :id

    belongs_to :depo_rate, Zrl.SystemUtilities.Station, foreign_key: :depo_stn_rate, type: :id
    belongs_to :commercial_clerk, Zrl.Accounts.User, foreign_key: :commercial_clerk_id, type: :id
    ...
    belongs_to :train_type, Zrl.SystemUtilities.TrainType, foreign_key: :train_type_id, type: :id
    # belongs_to :loco_driver, Zrl.Accounts.LocoDriver, foreign_key: :loco_driver_id, type: :id
    belongs_to :loco, Zrl.Locomotives.LocomotiveType, foreign_key: :loco_id, type: :id
    belongs_to :batch, Zrl.Order.Batch, foreign_key: :batch_id, type: :id

    belongs_to :refueling_type, Zrl.SystemUtilities.Refueling,
      foreign_key: :refuel_type,
      type: :id

    belongs_to :section_type, Zrl.SystemUtilities.Section, foreign_key: :section_id, type: :id
    belongs_to :user_region, Zrl.Accounts.UserRegion, foreign_key: :user_region_id, type: :id
    belongs_to :station, Zrl.SystemUtilities.Station, foreign_key: :user_station_id, type: :id
    belongs_to :locomotive, Zrl.Locomotives.Locomotive, foreign_key: :locomotive_id, type: :id
    belongs_to :yard_master, Zrl.Accounts.User, foreign_key: :yard_master_id, type: :id
    belongs_to :loco_driver, Zrl.Accounts.User, foreign_key: :locomotive_driver_id, type: :id
