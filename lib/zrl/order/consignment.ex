defmodule Zrl.Order.Consignment do
  use Ecto.Schema
  use Endon
  ...
  schema "tbl_consignments" do
    ...
    belongs_to :invoice_currency, Zrl.SystemUtilities.Currency,
      foreign_key: :invoice_currency_id,
      type: :id

    belongs_to :tariff_destination, Zrl.SystemUtilities.Station,
      foreign_key: :tariff_destination_id,
      type: :id

    belongs_to :tariff_origin, Zrl.SystemUtilities.Station,
      foreign_key: :tariff_origin_id,
      type: :id

    belongs_to :final_destin, Zrl.SystemUtilities.Station,
      foreign_key: :final_destination_id,
      type: :id

    belongs_to :origin_station, Zrl.SystemUtilities.Station,
      foreign_key: :origin_station_id,
      type: :id

    belongs_to :reporting_station, Zrl.SystemUtilities.Station,
      foreign_key: :reporting_station_id,
      type: :id

    belongs_to :commodity, Zrl.SystemUtilities.Commodity, foreign_key: :commodity_id, type: :id
    belongs_to :consignee, Zrl.Accounts.Clients, foreign_key: :consignee_id, type: :id
    belongs_to :consigner, Zrl.Accounts.Clients, foreign_key: :consigner_id, type: :id
    belongs_to :customer, Zrl.Accounts.Clients, foreign_key: :customer_id, type: :id
    belongs_to :payer, Zrl.Accounts.Clients, foreign_key: :payer_id, type: :id
    belongs_to :tarrif, Zrl.SystemUtilities.TariffLine, foreign_key: :tarrif_id, type: :id
    belongs_to :maker, Zrl.Accounts.User, foreign_key: :maker_id, type: :id
    belongs_to :acc_checker, Zrl.Accounts.User, foreign_key: :acc_checker_id, type: :id
    belongs_to :verifier, Zrl.Accounts.User, foreign_key: :verifier_id, type: :id
    belongs_to :checker, Zrl.Accounts.User, foreign_key: :checker_id, type: :id
    belongs_to :modifier, Zrl.Accounts.User, foreign_key: :modifier_id, type: :id
    belongs_to :wagon, Zrl.SystemUtilities.Wagon, foreign_key: :wagon_id, type: :id
    belongs_to :batch, Zrl.Order.Batch, foreign_key: :batch_id, type: :id
    belongs_to :route, Zrl.SystemUtilities.TrainRoute, foreign_key: :route_id, type: :id
    belongs_to :user_region, Zrl.Accounts.UserRegion, foreign_key: :user_region_id, type: :id
  ...
  defp does_route_exist?(%Ecto.Changeset{valid?: true} = changeset) do
    ...
    case Zrl.SystemUtilities.search_for_route(origin, destin) do
      nil ->
        origin_stat = Zrl.SystemUtilities.get_station!(origin)
        destin_stat = Zrl.SystemUtilities.get_station!(destin)
  ...
  defp empty_commodity(changeset) do
    case Zrl.SystemUtilities.empty_commodity_lookup() do
      nil ->
