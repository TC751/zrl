defmodule Zrl.Tracking.Haulage do
  use Ecto.Schema
  ...
  schema "tbl_haulage" do
    ...
    # field :admin_id, :id
    # field :rate_id, :id
    belongs_to :payee_admin, Zrl.Accounts.RailwayAdministrator, foreign_key: :payee_admin_id, type: :id
    ...
    belongs_to :haulage_rate, Zrl.SystemUtilities.HaulageRate, foreign_key: :rate_id, type: :id
  ...
  defp does_haulage_fee_exist?(%Ecto.Changeset{valid?: true} = changeset) do
    ...
    case Zrl.SystemUtilities.haulage_fee_lookup(admin, direction, date) do
      nil ->
        add_error(
          changeset,
          :Hauladge,
