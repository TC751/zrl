defmodule Zrl.Tracking.WagonTracking do
  use Ecto.Schema
  use Endon
  ...
  schema "tbl_wagon_tracking" do
    ...
    belongs_to :defects, Zrl.SystemUtilities.Defect, foreign_key: :defect_id, type: :id
    belongs_to :destination, Zrl.SystemUtilities.Station, foreign_key: :destination_id, type: :id
    belongs_to :origin, Zrl.SystemUtilities.Station, foreign_key: :origin_id, type: :id

    belongs_to :location, Zrl.SystemUtilities.Station,
    ...
    belongs_to :allocated_customer, Zrl.Accounts.Clients,
  ...
  defp does_movement_exist?(%Ecto.Changeset{valid?: true} = changeset) do
    ...
    case Zrl.Order.search_for_train_list_entry(wagon_id, train_no) do
      nil ->
  ...
  defp does_train_exist?(train_no, changeset) do
    case Zrl.Order.search_for_train(train_no) do
      nil ->
        add_error(changeset, :train_no, " \"#{train_no}\" does not exist")
  ...
  #      ) do
  #   case Zrl.SystemUtilities.wagon_lookup(wagon_code) do
  #     nil ->
  ...
  #      ) do
  #   case Zrl.SystemUtilities.wagon_status_lookup(code) do
  #     nil ->
  ...
  #      ) do
  #   case Zrl.SystemUtilities.domain_lookup(code) do
  #     nil ->
  ...
  #      ) do
  #   case Zrl.SystemUtilities.wagon_condition_lookup(code) do
  #     nil ->
