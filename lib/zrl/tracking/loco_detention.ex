defmodule Zrl.Tracking.LocoDetention do
  use Ecto.Schema
  ...
  schema "tbl_loco_detention" do
    ...
    belongs_to :dentention_rate, Zrl.SystemUtilities.LocoDetentionRate,
  ...
  defp does_loco_detention_rate_exist?(%Ecto.Changeset{valid?: true} = changeset) do
    ...
    case Zrl.SystemUtilities.loco_detention_rate_lookup(date, admin) do
      nil ->
        add_error(
          changeset,
          :Rate,
