defmodule Zrl.Tracking.Material do
  use Ecto.Schema
  ...
  schema "tbl_interchange_material" do
    ...
    belongs_to :spare_rate, Zrl.SystemUtilities.SpareFee, foreign_key: :spare_rate_id, type: :id
  ...
  defp does_material_fee_exist?(%Ecto.Changeset{valid?: true} = changeset) do
    ...
    case Zrl.SystemUtilities.spare_fee_lookup(date, admin, spare) do
      nil ->
        add_error(
          changeset,
          :Rate,
