defmodule Zrl.Tracking.Interchange do
  use Ecto.Schema
  use Endon
  ...
  schema "tbl_interchange" do
    ...
    belongs_to :interchange_pnt, Zrl.SystemUtilities.Station,
    ...
    belongs_to :destination_station, Zrl.SystemUtilities.Station,
    ...
    belongs_to :wagon_status, Zrl.SystemUtilities.Status, foreign_key: :wagon_status_id, type: :id

    belongs_to :current_station, Zrl.SystemUtilities.Station,
      foreign_key: :current_station_id,
      type: :id

    belongs_to :wagon_condition, Zrl.SystemUtilities.Condition,
      foreign_key: :wagon_condition_id,
      type: :id

    belongs_to :administrator, Zrl.Accounts.RailwayAdministrator,
      foreign_key: :adminstrator_id,
      type: :id

    belongs_to :interchange_fees, Zrl.SystemUtilities.InterchangeFee,
      foreign_key: :interchange_fee_id,
      type: :id

    belongs_to :region, Zrl.SystemUtilities.Region, foreign_key: :region_id, type: :id
    ...
    has_many :interchange_defects, Zrl.Tracking.InterchangeDefect,
  ...
  defp does_interchange_fee_exist?(%Ecto.Changeset{valid?: true} = changeset) do
    ...
    wagon = Zrl.SystemUtilities.get_wagon!(get_field(changeset, :wagon_id))
    wagon_type = wagon.wagon_type_id

    case Zrl.SystemUtilities.interchange_fee_lookup(String.slice(date, 0..-7), admin, wagon_type) do
      nil ->
        add_error(
          changeset,
          :Interchange,
