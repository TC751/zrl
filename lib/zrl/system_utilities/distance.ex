defmodule Zrl.SystemUtilities.Distance do
  use Ecto.Schema
  ...
  schema "tbl_distance" do
    ...
    belongs_to :destination, Zrl.SystemUtilities.Station, foreign_key: :destin, type: :id
    belongs_to :origin, Zrl.SystemUtilities.Station, foreign_key: :station_orig, type: :id
