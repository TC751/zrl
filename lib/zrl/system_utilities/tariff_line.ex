defmodule Zrl.SystemUtilities.TariffLine do
  use Ecto.Schema
  ...
  schema "tbl_tariff_line" do
    ...
    belongs_to :pay_type, Zrl.SystemUtilities.PaymentType, foreign_key: :pay_type_id, type: :id
    belongs_to :surcharge, Zrl.SystemUtilities.Surchage, foreign_key: :surcharge_id, type: :id

    belongs_to :orig_station, Zrl.SystemUtilities.Station,
    ...
    belongs_to :client, Zrl.Accounts.Clients, foreign_key: :client_id, type: :id

    has_many :rates, Zrl.SystemUtilities.TariffLineRate,
