defmodule Zrl.SystemUtilities.CompanyInfo do
  use Ecto.Schema
  ...
  schema "tbl_company_info" do
    ...
    belongs_to :currency, Zrl.SystemUtilities.Currency, foreign_key: :prefered_ccy_id, type: :id

    belongs_to :railway_admin, Zrl.Accounts.RailwayAdministrator,
      foreign_key: :current_railway_admin,
      type: :id

    belongs_to :log_admin, Zrl.Accounts.RailwayAdministrator,
