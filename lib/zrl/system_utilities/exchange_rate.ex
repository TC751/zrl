defmodule Zrl.SystemUtilities.ExchangeRate do
  use Ecto.Schema
  ...
  schema "tbl_exchange_rate" do
    ...
    belongs_to :first_ccy, Zrl.SystemUtilities.Currency, foreign_key: :first_currency, type: :id
    belongs_to :second_ccy, Zrl.SystemUtilities.Currency, foreign_key: :second_currency, type: :id
