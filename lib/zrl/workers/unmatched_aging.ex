defmodule Zrl.Workers.UnmatchedAging do
  ...
  defp read_template(summary) do
    html =
      Application.app_dir(:zrl, "priv/static/pdf_templates/unmatched_aging.html.eex")
      |> File.read!()
      ...
      Enum.map(summary, fn {name, types} ->
        ...
        html_str =
          Enum.map(types, fn type ->
            ...
            """
            <tr>
              <td style=" font-weight: normal !important; text-"> {{ commodity_type }}</td>
              <td style=" font-weight: normal !important;">{{ wagons }} </td>
              <td style=" font-weight: normal !important;">{{ tonnages }} </td>
              <td style=" font-weight: normal !important;">{{rate }}</td>
              <td style=" font-weight: normal !important;">{{amount }}</td>
            </tr>
            """
