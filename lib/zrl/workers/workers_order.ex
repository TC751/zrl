defmodule Zrl.Workers.WorkersOrder do
  ...
  defp read_template(item) do
    ...
    orders= Zrl.Order.works_order_lookup(item.client_id, item.train_no, item.area_name, item.departure_date)
    html =
      Application.app_dir(:zrl, "priv/static/pdf_templates/workers_order.html.eex")
      |> File.read!()
