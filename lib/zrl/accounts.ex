defmodule Zrl.Accounts do
  @moduledoc """
  def  do
  The Accounts context.
  """

  # Zrl.Accounts.search_client("g", 0)

  import Ecto.Query, warn: false
  alias Zrl.Repo

  alias Zrl.Accounts.User
  ...
  def get_loco_driver_data do
    ...
    |> join(:left, [u], l in Zrl.Accounts.LocoDriver, on:  u.id == l.user_id)
    |> select([u, l], %{
      id: u.id,
