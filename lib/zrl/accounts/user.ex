defmodule Zrl.Accounts.User do
  use Ecto.Schema
  ...
  schema "tbl_users" do
    ...
    belongs_to :role, Zrl.Accounts.UserRole, foreign_key: :role_id, type: :id
    ...
    has_many :tariffs, Zrl.SystemUtilities.TariffLine,
      foreign_key: :maker_id,
      on_delete: :nilify_all

    has_many :approved_tariffs, Zrl.SystemUtilities.TariffLine,
      foreign_key: :checker_id,
      on_delete: :nilify_all

    has_many :cmdty_groups, Zrl.SystemUtilities.CommodityGroup,
      foreign_key: :maker_id,
      on_delete: :nilify_all

    has_many :approved_cmdty_groups, Zrl.SystemUtilities.CommodityGroup,
      foreign_key: :checker_id,
      on_delete: :nilify_all
  ...
  # Zrl.Accounts.create_user(%{first_name: "Admin", last_name: "Initiator", email: "admin@zrl.com", username: "admin@zrl.com", password: "Password@06", status: "ACTIVE", user_role: "1", user_id: "1",  mobile: "0976527271", inserted_at: NaiveDateTime.utc_now, updated_at: NaiveDateTime.utc_now})
  # Zrl.Accounts.create_user(%{first_name: "Peter", last_name: "Chileshe", email: "peter@.com", username: "peter@.com", Password@06: "password", status: "ACTIVE", user_role: "1", user_id: "1",  mobile: "0976527271", inserted_at: NaiveDateTime.utc_now, updated_at: NaiveDateTime.utc_now})
end
