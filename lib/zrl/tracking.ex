defmodule Zrl.Tracking do
  ...
  alias Zrl.Tracking.WagonTracking
  alias Zrl.SystemUtilities.Region
  alias Zrl.SystemUtilities.Wagon
  ...
  alias Zrl.Tracking.Interchange
  ...
  def list_region_with_country_details do
    Region
    # |> where([a], a.id == ^id)
    |> join(:left, [a], c in Zrl.SystemUtilities.Country, on: a.id == c.region_id)
    |> select([a, c], %{
  ...
  def list_wagon_tracker_with_id(id) do
    ...
    |> join(:left, [a, b, _c, _d], e in Zrl.SystemUtilities.Station, on: a.destination_id == e.id)
    |> join(:left, [a, b, _c, _d, _e], f in Zrl.SystemUtilities.Station, on: a.origin_id == f.id)
    |> join(:left, [a, b, _c, _d, _e, _f], g in Zrl.SystemUtilities.Station,
      on: a.current_location_id == g.id
    )
    |> join(:left, [a, b, _c, _d, _e, _f, _g], k in Zrl.SystemUtilities.Commodity,
      on: a.commodity_id == k.id
    )
    |> join(:left, [a, b, _c, _d, _e, _f, _g, _k], l in Zrl.Accounts.Clients,
      on: a.customer_id == l.id
    )
    |> join(:left, [a, b, _c, _d, _e, _f, _g, _k, _l], m in Zrl.SystemUtilities.Condition,
      on: a.condition_id == m.id
    )
    |> join(:left, [a, b, _c, _d, _e, _f, _g, _k, _l, _m], n in Zrl.SystemUtilities.Status,
      on: a.departure == n.id
    )
    |> join(:left, [a, b, _c, _d, _e, _f, _g, _k, _l, _m, n], j in Zrl.SystemUtilities.Defect,
      on: a.defect_id == j.id
    )
    |> join(:left, [a, b, _c, d, _e, _f, _g, _k, _l, _m, n, j], o in Zrl.SystemUtilities.Country,
      on: d.country == o.code
    )
    |> join(
      :left,
      [a, b, _c, d, _e, _f, _g, _k, _l, _m, n, j, o],
      q in Zrl.SystemUtilities.Region,
      on: o.region_id == q.id
    )
    |> join(
      :left,
      [a, b, _c, d, _e, _f, _g, k, _l, _m, n, j, o, q],
      r in Zrl.SystemUtilities.CommodityGroup,
      on: k.com_group_id == r.id
    )
    |> join(
      :left,
      [a, b, _c, d, _e, _f, _g, k, _l, _m, n, j, o, q, r],
      s in Zrl.SystemUtilities.Domain,
      on: a.domain_id == s.id
    )
  ...
  def get_all_wagon_position(search_params, page, size, _user) do
    Zrl.SystemUtilities.Wagon
    |> where([a], not is_nil(a.wagon_status_id) and not is_nil(a.domain_id))
    |> join(:left, [a], b in Zrl.SystemUtilities.Status, on: a.wagon_status_id == b.id)
    |> join(:left, [a, b], c in Zrl.SystemUtilities.Domain, on: a.domain_id == c.id)
  ...
  def get_interchange_batch_by_uuid(uuid, status) do
    ...
    |> join(:left, [a, b], c in Zrl.SystemUtilities.WagonType, on: b.wagon_type_id == c.id)
    |> join(:left, [a, b, _c], d in Zrl.Accounts.RailwayAdministrator, on: b.owner_id == d.id)
    |> join(:left, [a, b, _c, _d], e in Zrl.Accounts.RailwayAdministrator,
      on: a.adminstrator_id == e.id
    )
    |> join(:left, [a, _b, _c, _d, _e], f in Zrl.SystemUtilities.Station,
      on: a.interchange_point == f.id
    )
    |> join(:left, [a, _b, _c, _d, _e, _f], g in Zrl.Locomotives.Locomotive,
      on: a.locomotive_id == g.id
    )
    |> join(:left, [a, _b, _c, _d, _e, _f, _g], h in Zrl.SystemUtilities.Status,
      on: a.wagon_status_id == h.id
    )
    |> join(:left, [a, _b, _c, _d, _e, _f, _g, _h], i in Zrl.SystemUtilities.InterchangeFee,
      on: a.interchange_fee_id == i.id
    )
    |> join(:left, [a, _b, _c, _d, _e, _f, _g, _h, _i], j in Zrl.SystemUtilities.Commodity,
  ...
  def on_hire_interchange_entries_lookup(train_no, auth_status, direction) do
    ...
    |> join(:left, [a], b in Zrl.SystemUtilities.Wagon, on: a.wagon_id == b.id)
    |> join(:left, [a, b], c in Zrl.SystemUtilities.WagonType, on: b.wagon_type_id == c.id)
    |> join(:left, [a, b, c], d in Zrl.Accounts.RailwayAdministrator, on: b.owner_id == d.id)
    |> join(:left, [a, b, c, d], e in Zrl.Accounts.RailwayAdministrator,
      on: a.adminstrator_id == e.id
    )
    |> join(:left, [a, b, c, d, e], f in Zrl.SystemUtilities.Station,
      on: a.interchange_point == f.id
    )
    |> join(:left, [a, b, c, d, e, f], g in Zrl.SystemUtilities.Station,
      on: a.origin_station_id == g.id
    )
    |> join(:left, [a, b, c, d, e, f, g], h in Zrl.SystemUtilities.Station,
      on: a.destination_station_id == h.id
    )
    |> join(:left, [a, b, c, d, e, f, g, h], i in Zrl.SystemUtilities.Commodity,
  ...
  def list_interchange_on_hire_emailing() do
    ...
    |> join(:left, [a, _b, _c, _d, _e, _f, _g, _h, _i, _j], k in Zrl.SystemUtilities.Station,
      on: a.origin_station_id == k.id
    )
    |> join(:left, [a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k], l in Zrl.SystemUtilities.Station,
  ...
  def interchange_train_no_lookup(train_no) do
    ...
    |> join(:left, [a, b, c, d, e, f, g, h, i], j in Zrl.SystemUtilities.Station,
      on: a.current_station_id == j.id
    )
    |> join(:left, [a, b, c, d, e, f, g, h, i, j], k in Zrl.SystemUtilities.Condition,
      on: a.wagon_condition_id == k.id
    )
    |> join(:left, [a, b, c, d, e, f, g, h, i, j, k], l in Zrl.SystemUtilities.Status,
  ...
  def interchange_off_hire_report_list_lookup(search_params, page, size, _user) do
    ...
    |> join(:left, [a, _b, _c, _d, _e, _f], g in Zrl.SystemUtilities.Station,
      on: a.origin_station_id == g.id
    )
    |> join(:left, [a, _b, _c, _d, _e, _f, _g], k in Zrl.SystemUtilities.Station,
    ...
    |> join(
      :left,
      [a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _n, _o],
      p in Zrl.SystemUtilities.Status,
  ...
  alias Zrl.Tracking.InterchangeDefect
  ...
  def interchange_defect_lookup(id) do
    ...
    |> join(:left, [a], b in Zrl.SystemUtilities.SpareFee, on: a.spare_id == b.id)
    |> join(:left, [a, b], c in Zrl.SystemUtilities.Spare, on: b.spare_id == c.id)
    |> join(:left, [a, b, c], d in Zrl.SystemUtilities.Currency, on: b.currency_id == d.id)
    |> select([a, b, c, d], %{
      id: a.id,
      code: c.code,
  ...
  def get_all_wagon_tracker(search_params, page, size, _user) do
    ...
    |> join(:left, [a, b, _c, d, _e, _f, _g, _k, _l, _m], n in Zrl.SystemUtilities.Country,
      on: d.country == n.code
    )
    |> join(:left, [a, b, _c, d, _e, _f, _g, _k, _l, _m, n], o in Zrl.SystemUtilities.Region,
      on: n.region_id == o.id
    )
    |> join(:left, [a, b, _c, d, _e, _f, _g, _k, _l, _m, n, o], p in Zrl.SystemUtilities.Domain,
      on: a.domain_id == p.id
    )
  ...
  def get_wagon_tracker_grouped_by_allocation(query) do
    ...
    |> join(:left, [a], b in Zrl.SystemUtilities.Wagon, on: a.wagon_id == b.id)
    |> join(:left, [a, b], c in Zrl.Accounts.RailwayAdministrator, on: b.owner_id == c.id)
    |> join(:left, [a, b, c], d in Zrl.SystemUtilities.Country, on: c.country == d.code)
    |> join(:left, [a, b, c, d], e in Zrl.SystemUtilities.Region, on: d.region_id == e.id)
    |> join(:left, [a, b, c, d, e], f in Zrl.Accounts.Clients, on: a.allocated_cust_id == f.id)
  ...
  def wagon_allocation_lookup(search_params, page, size, _user) do
    ...
    |> join(:left, [a], c in Zrl.Accounts.RailwayAdministrator, on: a.owner_id == c.id)
    |> join(:left, [a, c], d in Zrl.SystemUtilities.Country, on: c.country == d.code)
    |> join(:left, [a, c, d], e in Zrl.SystemUtilities.Domain, on: a.domain_id == e.id)
    |> join(:left, [a, c, d, e], f in Zrl.Accounts.Clients,
  ...
  def get_all_wagon_yard_position(search_params, page, size, _user) do
    ...
    |> join(:left, [b], c in Zrl.SystemUtilities.Station, on: b.station_id == c.id)
    |> join(:left, [b, c], d in Zrl.Accounts.RailwayAdministrator, on: b.owner_id == d.id)
    |> join(:left, [b, c, d], e in Zrl.SystemUtilities.Commodity, on: b.commodity_id == e.id)
  ...
  def get_wagon_daily_position() do
    WagonTracking
    |> join(:left, [a], b in Zrl.SystemUtilities.Wagon, on: a.wagon_id == b.id)
    |> join(:left, [a, b], c in Zrl.SystemUtilities.Station, on: a.current_location_id == c.id)
    |> join(:left, [a, b, c], d in Zrl.SystemUtilities.Status, on: a.departure == d.id)
  ...
  def get_delayed_wagon(query) do
    query
    |> join(:left, [a], b in Zrl.SystemUtilities.Wagon, on: a.wagon_id == b.id)
    |> join(:left, [a, b], c in Zrl.SystemUtilities.Status, on: a.departure == c.id)
  ...
  def get_all_wagons_by_condition(search_params, page, size, _user) do
    ...
    |> join(:left, [a], b in Zrl.SystemUtilities.Domain, on: a.domain_id == b.id)
    |> join(:left, [a, b], c in Zrl.SystemUtilities.Condition, on: a.condition_id == c.id)
  ...
  def get_wagon_tracker_grouped_by_wagon_symbol() do
    ...
    |> join(:left, [a], b in Zrl.SystemUtilities.Wagon, on: a.wagon_id == b.id)
    |> join(:left, [a, b], c in Zrl.SystemUtilities.Status, on: a.departure == c.id)
    |> join(:left, [a, b, c], d in Zrl.SystemUtilities.Domain, on: a.domain_id == d.id)
  ...
  def delayed_wagons_lookup(start_end, end_date) do
    ...
    |> join(:inner, [a, b], c in Zrl.SystemUtilities.CompanyInfo,
  ...
  def count_wagons(start_end, end_date) do
    ...
    |> join(:left, [a], b in Zrl.SystemUtilities.Wagon, on: a.wagon_id == b.id)
    |> join(:left, [a, b], c in Zrl.SystemUtilities.CompanyInfo,
      on: b.owner_id == c.current_railway_admin
    )
  ...
  def bad_order_lookup do
    Wagon
    |> join(:inner, [a], b in Zrl.SystemUtilities.Condition, on: a.condition_id == b.id)
  ...
  def wagon_daily_log do
    load_params = Zrl.Tracking.wagon_load_status_lookup() |> Enum.at(0)
    bo_params = Zrl.Tracking.bad_order_lookup()
  ...
  def bad_order_average_lookup(query) do
    query
    |> join(:inner, [a], b in Zrl.SystemUtilities.Condition, on: a.conditon_id == b.id)
  ...
  alias Zrl.Tracking.WagonTrkSpares
  ...
  def defect_spares_lookup(tracker_id, wagon_id) do
    ...
    |> join(:left, [a], b in Zrl.SystemUtilities.Spare, on: a.spare_id == b.id)
    |> join(:left, [a, b], c in Zrl.SystemUtilities.SpareFee,
      on:
  ...
  def material_report_lookup(search_params, page, size, _user) do
    Material
    |> join(:left, [a], b in Zrl.SystemUtilities.Spare, on: a.spare_id == b.id)
    |> join(:left, [a, b], c in Zrl.Accounts.RailwayAdministrator, on: a.admin_id == c.id)
    |> join(:left, [a, b, c], d in Zrl.Accounts.User, on: a.maker_id == d.id)
    |> join(:left, [a, b, c, d], e in Zrl.SystemUtilities.Currency, on: a.currency_id == e.id)
  ...
  def auxiliary_report_lookup(
    ...
    |> join(:left, [a], b in Zrl.SystemUtilities.Equipment, on: a.equipment_id == b.id)
    |> join(:left, [a, b], c in Zrl.Accounts.RailwayAdministrator, on: a.admin_id == c.id)
    |> join(:left, [a, b, c], d in Zrl.Accounts.User, on: a.maker_id == d.id)
    |> join(:left, [a, b, c, d], e in Zrl.SystemUtilities.Currency, on: a.currency_id == e.id)
    |> join(:left, [a, b, c, d, e], f in Zrl.SystemUtilities.Station,
    ...
    |> join(:left, [a, b, c, d, e, f, g], h in Zrl.SystemUtilities.Wagon, on: a.wagon_id == h.id)
  ...
  def auxiliary_lookup(id) do
    ...
    |> join(:left, [a, b, c, d, e, f, g], h in Zrl.SystemUtilities.Wagon, on: a.wagon_id == h.id)
    |> join(:left, [a, b, c, d, e, f, g, h], i in Zrl.Accounts.RailwayAdministrator, on: i.id == h.owner_id)
    |> join(:left, [a, b, c, d, e, f, g, h, i], j in Zrl.SystemUtilities.Wagon, on: a.current_wagon_id == j.id)
    |> join(:left, [a, b, c, d, e, f, g, h, i, j], k in Zrl.Accounts.RailwayAdministrator, on: k.id == j.owner_id)
  ...
  def auxiliary_tracking_lookup(wagon_code, equipment_id) do
    ...
    |> join(:left, [a, b, c, d, e, f, g], h in Zrl.SystemUtilities.Wagon, on: a.wagon_id == h.id)
    |> join(:left, [a, b, c, d, e, f, g, h], i in Zrl.SystemUtilities.Wagon,
  ...
  def auxiliary_bulk_tracking_lookup(direction, equipment_id) do
    ...
    |> join(:left, [a, b, c, d, e, f, g, h, i], j in Zrl.Accounts.RailwayAdministrator,
      on: i.owner_id == j.id
    )
  ...
  alias Zrl.Tracking.LocoDetention
  ...
  def loco_detention_report_lookup(
    ...
    |> join(:left, [a], b in Zrl.Locomotives.Locomotive, on: a.locomotive_id == b.id)
    |> join(:left, [a, b], c in Zrl.Accounts.RailwayAdministrator, on: a.admin_id == c.id)
    |> join(:left, [a, b, c], d in Zrl.Accounts.User, on: a.maker_id == d.id)
    |> join(:left, [a, b, c, d], e in Zrl.SystemUtilities.Currency, on: a.currency_id == e.id)
    |> join(:left, [a, b, c, d, e], f in Zrl.Accounts.User, on: f.checker_id == e.id)
  ...
  def haulage_report_lookup(%{"direction" => direction} = search_params, page, size, _user) do
    ...
    |> join(:left, [a], b in Zrl.Accounts.RailwayAdministrator, on: a.admin_id == b.id)
    |> join(:left, [a, b], c in Zrl.Accounts.User, on: a.maker_id == c.id)
    |> join(:left, [a, b, c], d in Zrl.SystemUtilities.Currency, on: a.currency_id == d.id)
  ...
  #   Zrl.Tracking.InterchangeDefect
  #   |> where([a], a.direction == ^direction)
  #   |> join(:left, [a], b in Zrl.Accounts.RailwayAdministrator, on: a.admin_id == b.id)
  #   |> join(:left, [a, b], c in Zrl.Accounts.User, on: a.maker_id == c.id)
  #   |> join(:left, [a, b, c], d in Zrl.SystemUtilities.Currency, on: a.currency_id == d.id)
  ...
  def mechanical_bills_report_lookup(_source, search_params, _user) do
    Zrl.Tracking.InterchangeDefect
    |> join(:left, [a], b in Zrl.SystemUtilities.Defect, on: a.defect_id == b.id)
    |> join(:left, [a, b], c in Zrl.Tracking.Interchange,
      on: a.interchange_id == c.id and a.wagon_id == c.wagon_id
    )
    |> join(:left, [a, b, c], d in Zrl.SystemUtilities.DefectSpare, on: a.defect_id == d.defect_id)
    |> join(:left, [a, b, c, d], e in Zrl.SystemUtilities.SpareFee,
      on: d.spare_id == e.spare_id and c.adminstrator_id == e.railway_admin
    )
    |> join(:left, [a, b, c, d, e], f in Zrl.SystemUtilities.Spare, on: d.spare_id == f.id)
    |> join(:left, [a, b, c, d, e, f], g in Zrl.SystemUtilities.Currency,
      on: e.currency_id == g.id
    )
    |> join(:left, [a, b, c, d, e, f, g], h in Zrl.SystemUtilities.Wagon, on: a.wagon_id == h.id)
    |> join(:left, [a, b, c, d, e, f, g, h], i in Zrl.Accounts.RailwayAdministrator,
  ...
  def demurrage_report_lookup(search_params, page, size, _user) do
    ...
    |> join(:left, [a, b], c in Zrl.Accounts.RailwayAdministrator, on: b.owner_id == c.id)
    |> join(:left, [a, b, c], d in Zrl.Accounts.User, on: a.maker_id == d.id)
    |> join(:left, [a, b, c, d], e in Zrl.SystemUtilities.Commodity, on: a.commodity_in_id == e.id)
    |> join(:left, [a, b, c, d, e], f in Zrl.SystemUtilities.Commodity,
  ...
  def haulage_rows(admin_id, direction, start_dt, end_dt) when not is_nil(start_dt) and not is_nil(end_dt) do
    settings = Zrl.SystemUtilities.list_company_info()
  ...
  def wagon_turn_around_lookup(direction, from, to) do
    Interchange
    |> join(:left, [a], b in Zrl.Accounts.RailwayAdministrator, on: b.id == a.adminstrator_id)
